...
export function SiteHeader() {
  ...
  // Show the header once the user has scrolled far enough that the chat
  // widget has finished docking. The threshold (~70% of vh) matches the
  // end of the useChatMorph scroll range (+=500px ≈ 70% of a 720px vh).
  useEffect(() => {
    function onScroll() {
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="text-xl font-bold tracking-tight font-heading text-primary cursor-default select-none">
          ABK
          <span className="text-xs ml-1.5 font-medium text-muted-foreground">dev</span>
        </div>
